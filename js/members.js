...
var choreographers = [
    {
        ...
        "title": "Traditional Choreographer, Chess",
        "name": "Kedi Hu",
        "year": "Class of 2020",
        "fun": "I am not fun :(",
        "image": "kedi.png"
    ...
    for (var i = 0; i < exec.length; i++) {
        ...
        var person = '<div class="person">'
            ...
            + '<div class="info">'
                ...
                + '<p class="fun desktop">' + info.fun + '</p></div>'
                + '<p class="fun mobile">' + info.fun + '</p></div>';
        $('#exec .section-container').append(person);
    }
